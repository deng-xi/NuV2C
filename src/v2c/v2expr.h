...
class verilog_exprt: public messaget
{
    ...
    const namespacet ns;
	  ...
	  const irep_idt &curr_module_backup, const std::set<irep_idt>::iterator &in_progress_it, std::ostream &out);
      ...
      int register_present;
        ...
        exprt convert_expr(const exprt &expression, bool *changed);
};
